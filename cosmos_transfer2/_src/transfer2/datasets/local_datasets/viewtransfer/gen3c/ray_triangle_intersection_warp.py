...
def ray_triangle_intersection_kernel(
    ...
    ray_origin = wp.vec3(ray_origins[ray_idx, 0], ray_origins[ray_idx, 1], ray_origins[ray_idx, 2])
    ray_dir = wp.vec3(ray_directions[ray_idx, 0], ray_directions[ray_idx, 1], ray_directions[ray_idx, 2])
